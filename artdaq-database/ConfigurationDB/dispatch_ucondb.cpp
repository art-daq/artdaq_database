...
#define TRACE_NAME "dispatch_ucondb.cpp"
...
JSONDocument prov::readDocument(ManageDocumentOperation const& options, JSONDocument const& search_payload) {
  ...
  TLOG(26) << "read_document: Search returned " << collection.size() << " results.";
...
void cf::debug::UconDB() {
  ...
  TLOG(10) << "artdaq::database::configuration::UconDB trace_enable";
}
