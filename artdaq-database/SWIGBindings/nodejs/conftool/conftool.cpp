...
result_pair_t find_global_configurations_ui(std::string const& search_filter) {
  return impl::find_global_configurations(search_filter);
}
...
result_pair_t create_new_global_configuration_ui(std::string const& search_filter) {
  return impl::create_new_global_configuration(search_filter);
}
result_pair_t find_configuration_versions_ui(std::string const& search_filter) {
  return impl::find_configuration_versions(search_filter);
}
result_pair_t find_configuration_entities_ui(std::string const& search_filter) {
  return impl::find_configuration_entities(search_filter);
}
...
result_pair_t store_globalconfiguration_ui(std::string const& search_filter, std::string const& json_document) {
