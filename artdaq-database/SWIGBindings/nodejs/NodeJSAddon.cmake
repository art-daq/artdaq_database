...
macro (create_nodejs_addon)
    if(CAN_BUILD)
        ...
        install (FILES ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CNA_ADDON_NAME}.node DESTINATION ${flavorqual_dir}/lib/node_modules/${CNA_ADDON_NAME})

        add_custom_command(TARGET ${CNA_ADDON_NAME} POST_BUILD 
            COMMAND echo "**** Exports for ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CNA_ADDON_NAME}.node"
        COMMAND echo "**** BEGIN"
        COMMAND /usr/bin/nm ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CNA_ADDON_NAME}.node | /bin/egrep -e \"^[a-f0-9]{1,16} [T]\" | /usr/bin/c++filt  
        COMMAND echo "**** END" )
