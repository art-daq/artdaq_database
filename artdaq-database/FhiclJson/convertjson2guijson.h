...
struct value_crt {
  value_crt(value_t const& val)
  :value{val}{}
  value_t const& value;
};

struct value_rt {
  value_rt(value_t& val)
  :value{val}{}
  value_t& value;
};


using json_any_cref_t = boost::variant <
                        value_t const&,  //VALUE =1
...
using json_any_ref_t = boost::variant <
                        value_t &,  //VALUE =1
			value_rt&,  //VALUE =1
                        data_t &,   //DATA  =2
                        object_t &, //OBJECT=3
...
class json_node_t final
{
    struct type_visitor :public boost::static_visitor<type_t> {
        type_t operator() ( value_t const& ) const {
            return type_t::VALUE;
        }
        type_t operator() ( value_rt const& ) const {
            return type_t::VALUE;
        }
        type_t operator() ( data_t const& ) const {
            return type_t::DATA;
        }
        type_t operator() ( object_t const& ) const {
            return type_t::OBJECT;
        }
        type_t operator() ( array_t const& ) const {
            return type_t::ARRAY;
        }
        type_t operator() ( value_t& ) const {
            return type_t::VALUE;
        }
        type_t operator() ( value_crt const& ) const {
            return type_t::VALUE;
        }        
        type_t operator() ( data_t& ) const {
            return type_t::DATA;
        }
        type_t operator() ( object_t& ) const {
            return type_t::OBJECT;
        }
        type_t operator() ( array_t& ) const {
            return type_t::ARRAY;
        }
    };
...
public:
    template< typename T>
    json_node_t ( T & t )
        :_any {json_any_ref_t{t}} {}

    template< typename T>
    json_node_t ( T const& t )
        :_any {json_any_cref_t{t}} {}
...
public:
    ...
    std::string typeName() const {
        return _string_value_of ( literal::type );
    }
    std::string comment() const {
        return _string_value_of ( literal::comment );
    }
    std::string annotation() const {
        return _string_value_of ( literal::annotation );
    }
...
struct jcunwrapper {
    ...
    operator object_t const& () {
        return boost::get<object_t const&>(any);
    }

    operator array_t const& () {
        return boost::get<array_t const&>(any);
    }

    operator data_t const& () {
        return boost::get<data_t const&>(any);
    }

    operator value_t const& () {
        return boost::get<value_t const&>(any);
    }
