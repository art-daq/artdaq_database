 ...
 public:
  ...
  T const& value_as() const {
    ...
    if (_any.which() == 0) {
      ...
      TLOG(12) << "json_node_t() value_as() any.which()=" << _any.which() << " const value.which()=" << value.which();
  ...
  T& value_as() {
    ...
    TLOG(12) << "json_node_t() value_as() any.which()=" << _any.which() << " value.which()=" << value.which();
