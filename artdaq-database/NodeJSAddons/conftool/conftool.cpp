...
result_pair_t load_globalconfiguration_ui(std::string const& search_filter) {auto conf= std::string{}; return impl::load_globalconfiguration(search_filter,conf);}
result_pair_t store_globalconfiguration_ui(std::string const& search_filter, std::string const& json_document) {return impl::store_globalconfiguration(search_filter,json_document);}
