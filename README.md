...
This package contains a configuration database implementation for _artdaq_ and related products, using either JSON files on disk or a MongoDB implementation.
