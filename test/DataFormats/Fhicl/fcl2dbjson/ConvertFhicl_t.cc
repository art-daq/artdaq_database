...
bool test_convert2fcl(std::string const& /*input*/, std::string const& /*compare*/, std::string const& /*source_filename*/);
bool test_convert2json(std::string const& /*input*/, std::string const& /*compare*/, std::string const& /*source_filename*/);
bool test_roundconvertfcl(std::string const& /*input*/, std::string const& /*compare*/, std::string const& /*source_filename*/);
bool test_roundconvertjson(std::string const& /*input*/, std::string const& /*compare*/, std::string const& /*source_filename*/);

// Helper function to extract test number from filename
// e.g., "test001.src.fcl" -> "001"
