...
struct TestConfiguration003 final : public ConfigurationBase {
  std::string getConfigurationName() const { return "TestConfiguration003"; }
  ConfigurationView& getView() { return view; }
  ConfigurationView const& getView() const { return view; }
