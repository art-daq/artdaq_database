...
int main(int argc, char* argv[]) try {
  ...
  desc.add_options()("source,s", bpo::value<std::string>(), "Input source file.")("compare,x", bpo::value<std::string>(),
                                                                                  "Expected result of convertion.")("help,h", "produce help message");
