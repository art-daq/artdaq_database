...
int main(int argc, char* argv[]) try {
 ...
 // artdaq::database::docrecord::debug::JSONDocument();
  ...
  cf::registerOperation<cf::opsig_str_t, cf::opsig_str_t::FP, std::string const&>(apiliteral::operation::exportcollection,
                                                                                  export_collection, options_string);

  cf::registerOperation<cf::opsig_str_t, cf::opsig_str_t::FP, std::string const& >(apiliteral::operation::importcollection,
                                                                                  import_collection, options_string);

  cf::registerOperation<cf::opsig_str_t, cf::opsig_str_t::FP, std::string const&>(apiliteral::operation::exportdatabase,
                                                                                  export_database, options_string);

  cf::registerOperation<cf::opsig_str_t, cf::opsig_str_t::FP, std::string const&>(apiliteral::operation::importdatabase,
                                                                                  import_database, options_string);
  ...
  auto cmpdoc = std::string((std::istreambuf_iterator<char>(is)), std::istreambuf_iterator<char>());
  is.close();
  ...
  std::copy(retdoc.begin(), retdoc.end(), std::ostream_iterator<char>(os));
  os.close();
