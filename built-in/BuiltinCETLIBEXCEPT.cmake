...
if ( NOT EXISTS ${TOP_CMAKE_BINARY_DIR}/built-in/cetlib_except )
    ...
    execute_process(COMMAND rm -rf ${TOP_CMAKE_BINARY_DIR}/built-in/cetlib_except
        WORKING_DIRECTORY  ${TOP_CMAKE_BINARY_DIR}/built-in)

    execute_process(COMMAND git clone https://cdcvs.fnal.gov/projects/cetlib_except ${TOP_CMAKE_BINARY_DIR}/built-in/cetlib_except
        WORKING_DIRECTORY  ${TOP_CMAKE_BINARY_DIR}/built-in)

    execute_process(COMMAND  git checkout tags/v1_07_02
