...
if ( NOT EXISTS ${TOP_CMAKE_BINARY_DIR}/built-in/cetlib )
    ...
    execute_process(COMMAND rm -rf ${TOP_CMAKE_BINARY_DIR}/built-in/cetlib
       WORKING_DIRECTORY  ${TOP_CMAKE_BINARY_DIR}/built-in)

    execute_process(COMMAND git clone https://cdcvs.fnal.gov/projects/cetlib ${TOP_CMAKE_BINARY_DIR}/built-in/cetlib
       WORKING_DIRECTORY  ${TOP_CMAKE_BINARY_DIR}/built-in)
