...
if ( NOT EXISTS ${TOP_CMAKE_BINARY_DIR}/built-in/fhicl-cpp )
    ...
    execute_process(COMMAND rm -rf ${TOP_CMAKE_BINARY_DIR}/built-in/fhicl-cpp
         WORKING_DIRECTORY  ${TOP_CMAKE_BINARY_DIR}/built-in)

    execute_process(COMMAND git clone https://cdcvs.fnal.gov/projects/fhicl-cpp ${TOP_CMAKE_BINARY_DIR}/built-in/fhicl-cpp
         WORKING_DIRECTORY  ${TOP_CMAKE_BINARY_DIR}/built-in)
