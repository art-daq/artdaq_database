...
Implements the operation option class for managealiases operations. Provides configuration interface for setting up database operations.

**Location**: `/home/user/artdaq-database/artdaq-database/ConfigurationDB/options_operation_managealiases.h`
...
**Classes/Structs**: JsonData, ManageAliasesOperation
